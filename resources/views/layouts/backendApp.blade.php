                        ...
                        <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                            <li class="nav-item dropdown">
                                <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <img src="{{ Avatar::create(auth()->user()->name)->setDimension(32)->setFontSize(16)->toBase64() }}"
                                        alt="$category->name">
                                </a>
                    ...
                    <div class="mdk-drawer__content">
                        <div class="sidebar sidebar-light sidebar-left sidebar-p-t" data-perfect-scrollbar>
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item {{ Route::is('backend.home') ? 'active open' : '' }}">
                                ...
                                <li class="sidebar-menu-item {{ Route::is('backend.order.*') ? 'active open' : '' }}">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="product_menu">
                                        ...
                                        <li
                                            ...
                                            <a class="sidebar-menu-button"
                                                ...
                                                <span class="sidebar-menu-text">Product Create</span>
                                            </a>
                                        </li>
                                        <li
                                ...
                                <li class="sidebar-menu-item {{ Route::is('backend.coupon.*') ? 'active open' : '' }}">
                                ...
                                <li class="sidebar-menu-item {{ Route::is('backend.shippingcondition.*') ? 'active open' : '' }}">
                                    <a class="sidebar-menu-button" href="{{ route('backend.shippingcondition.index') }}">
                                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">slideshow</i>
                                ...
                                <a href="profile.html"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        ...
                                        @foreach (auth()->user()->roles as $role)
                                            <small class="text-muted text-uppercase">{{ $role->name }}</small>
                                        @endforeach
                                    </span>
                                </a>
